  ...
  return (
    <section className='max-padd-container py-16'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5'>
        {blogs.map((blog) => (
          <div key={blog.title} className='border-[11px] border-primary overflow-hidden relative group'>
            ...
            <div className='absolute bottom-4 left-4 text-white text-[15px]'>
              ...
              <button className='bg-white/30 py-0.5 px-5 medium-14 rounded hover:bg-white/50 transition-all duration-300'>
                Continue Reading
              </button>
            </div>
          </div>
